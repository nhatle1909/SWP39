<%-- 
    Document   : bird
    Created on : Jun 9, 2023, 8:29:27 AM
    Author     : ADMIN
--%>
                    ...
                    <div class="u-repeater u-repeater-1"><!--product_item-->
                        ...
                        <div class="u-align-center u-container-style u-products-item u-repeater-item u-shape-rectangle">
                                ...
                                <div class="u-container-layout u-similar-container u-valign-bottom u-container-layout-1"><!--product_image-->
                                    <img alt="" class="u-image u-product-control u-image-1" src="<%= birdList.getBird_images()%>" data-animation-name="customAnimationIn" data-animation-duration="1000"><!--/product_image-->
                                    <h4 class="u-text u-text-default u-text-1" data-animation-name="customAnimationIn" data-animation-duration="1000">
                                        <a class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-body-color u-btn" href="Mazuri.html"><%= birdList.getBird_name()%></a>
                                    </h4>
                                    <p class="u-text u-text-default u-text-palette-2-base u-text" data-animation-name="customAnimationIn" data-animation-duration="1000">Food : <%= birdList.getProduct_name()%></p>
                                    <p class="u-text u-text-default u-text-palette-2-base u-text" data-animation-name="customAnimationIn" data-animation-duration="1000">Species : <%=birdList.getSpecies()%></p> 
